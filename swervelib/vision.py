...
class AprilTagCameraCollection:
    ...
    def estimate_pose(self, previous_estimated_pose: wpimath.geometry.Pose3d) -> wpimath.geometry.Pose3d:
        self.pose_estimator.setReferencePose(previous_estimated_pose)
